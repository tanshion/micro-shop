...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = {NullablePattern.NullablePatternValidatorInner.class})
public @interface NullablePattern {
     ...
     */
    class NullablePatternValidatorInner implements ConstraintValidator<NullablePattern, Object> {
